...
### Project blog
  ...
  http://tjohsoft.blogspot.com

### Wiki manual

  https://github.com/AmRobertJohn
  
### Requirements
	apt-get update
	apt-get install -y build-essential git libpcre3 libpcre3-dev openssl libssl-dev zlibc zlib1g zlib1g-dev
